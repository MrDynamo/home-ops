...
| epg-matcharr             | 2 Gi  | Tuesday @ 10:00              | `0 10 * * 2`    | `0 15 * * 2`       | `0 16 * * 2`       |
...
| paperless-gpt            | 2 Gi  | Friday @ 11:00               | `0 11 * * 5`    | `0 16 * * 5`       | `0 17 * * 5`       |
| pgadmin                  | 1 Gi  | Tuesday @ 11:00              | `0 11 * * 2`    | `0 16 * * 2`       | `0 17 * * 2`       |
| plex                     | 18 Gi | Monday @ 07:00               | `0 7 * * 1`     | `0 12 * * 1`       | `0 13 * * 1`       |
| prowlarr                 | 1 Gi  | Thursday @ 07:00             | `0 7 * * 4`     | `0 12 * * 4`       | `0 13 * * 4`       |
| radarr                   | 6 Gi  | Wednesday @ 08:00            | `0 8 * * 3`     | `0 13 * * 3`       | `0 14 * * 3`       |
...
| teamarr                  | 2 Gi  | Tuesday @ 10:00              | `0 10 * * 2`    | `0 15 * * 2`       | `0 16 * * 2`       |
