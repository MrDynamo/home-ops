...
| paperless     | 2Gi  | Friday @ 11:00               | `0 11 * * 5`    | `0 16 * * 5`       | `0 17 * * 5`       |
| paperless-ai  | 2Gi  | Friday @ 11:00               | `0 11 * * 5`    | `0 16 * * 5`       | `0 17 * * 5`       |
| plex          | 18Gi | Monday @ 07:00               | `0 7 * * 1`     | `0 12 * * 1`       | `0 13 * * 1`       |
| prowlarr      | 1Gi  | Thursday @ 07:00             | `0 7 * * 4`     | `0 12 * * 4`       | `0 13 * * 4`       |
| radarr        | 4Gi  | Wednesday @ 08:00            | `0 8 * * 3`     | `0 13 * * 3`       | `0 14 * * 3`       |
...
| your-spotify  | 2Gi  | Wednesday @ 11:00            | `0 11 * * 3`    | `0 16 * * 3`       | `0 17 * * 3`       |
